...
def merge(arr, p: int, q: int, r: int):
    ...
    while right < n_right_arr:
        ...
        right += 1
        dest_i += 1
    # question : why do we need the 2 extra while loop?
    # it is for when the right or left arr is empty, and we do not need to compare anymore
    print(f"arr {arr}")


if __name__ == "__main__":
    arr = [50, 12, 5, 4, 3, 11, 54, 21]
